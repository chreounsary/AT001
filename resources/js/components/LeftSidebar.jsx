...
function LeftSidebar() {
  return (
    <aside className='md:w-18 md:w-18 sm:w-12 lg:w-16 flex flex-col text-white justify-between bg-[#272A35] min-h-screen'>
        <div className="flex flex-col items-center h-2/3 p-1 gap-y-4">
            <div className="pt-2">
            ...
            <div className='sidebar-button-style px-1'>
                <Link to="/">
            ...
            <div className='sidebar-button-style px-1'>
                ...
                <p className='text-xs font-light'>Slots</p>
            </div>
            <div className='sidebar-button-style px-1'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
            ...
            <div className='sidebar-button-style px-1'>
                ...
                <p className='text-xs font-light'>Card</p>
            </div>
            <div className='sidebar-button-style px-1'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8">
                ...
                <p className='text-xs font-light'>Lotory</p>
            </div>
        </div>
        <div className='flex flex-col items-center gap-y-2'>
            ...
            <div className='sidebar-button-style px-1'>
                ...
                <p className='text-xs font-light'>Help</p>
            </div>
        </div>
    </aside>
  )
